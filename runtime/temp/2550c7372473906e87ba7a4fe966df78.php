<?php /*a:1:{s:81:"D:\phpstudy_pro\WWW\watchstore\application\admin\view\admin_order\order_edit.html";i:1601019564;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <form class="layui-form order-edit-top">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input layui-disabled" value="<?php echo htmlentities($item['date']); ?>" id="date" name="date"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input layui-disabled" value="<?php echo htmlentities($item['payment']); ?>" id="payment" name="payment"
                        required="" autocomplete="off" class="layui-input" disabled="">
                </div>
                <div class="layui-form-mid layui-word-aux">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo htmlentities($item['pay']); ?>" id="pay" name="pay" required="" autocomplete="off"
                        class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo htmlentities($item['expressNum']); ?>" id="expressNum" name="expressNum" autocomplete="off"
                        class="layui-input">
                </div>
            </div>
