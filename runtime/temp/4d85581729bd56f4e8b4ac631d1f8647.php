<?php /*a:3:{s:76:"D:\phpstudy_pro\WWW\watchstore\application\product\view\product\details.html";i:1599789369;s:40:"public/static/product/header/header.html";i:1600172054;s:40:"public/static/product/footer/footer.html";i:1600066032;}*/ ?>
<!DOCTYPE html>
...
</div><!-- breadcrumbs-area-end --><!-- product-main-area-start -->
<div class="product-main-area mb-70" style="margin-bottom: 0px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12"><!-- product-main-area-start -->
                    ...
                    <div class="row">
                            ...
                            <div class="flexslider">
                                <div class="flex-viewport" style="overflow: hidden; position: relative;">
                                    <ul class="slides"
                                        ...
                                        <li data-thumb="/upload/img/<?php echo htmlentities($imgItem['img']); ?>" class="clone" aria-hidden="true" style="text-align: center !important; display: block;">
                                            <img src="/upload/img/<?php echo htmlentities($imgItem['img']); ?>" style="width: auto;height: auto" alt="woman" draggable="false">
                                        </li>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                            <div class="product-info-main">
                                <div class="page-title"><h1><?php echo htmlentities($watchData['bname']); ?></h1></div>
                                <div class="product-info-stock-sku">
                                    <div class="product-attribute">
                                    </div>
                                </div>
                                <div class="product-reviews-summary" style="border-bottom: none;margin-bottom: 0px;">
                                    <div class="rating-summary"><a
                                            href="#"><i
                                ...
                                <div class="product-social-links">
                                    ...
                                    <div class="product-addto-links-text"><p><?php echo htmlentities($watchData['detail']); ?></p></div>
                                </div>
                ...
                </div><!-- product-main-area-end --><!-- product-info-area-start -->
                <div class="new-book-area mt-60">
                    <div class="tab-active-2 owl-carousel owl-loaded owl-drag"><!-- single-product-start -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="shop-left">
                    <div class="left-title mb-20"><h4>相关</h4></div>
                                            ...
                                            <div class="single-most-product bd mb-18">
                                                ...
                                                <div class="most-product-content">
                                                    <div class="product-rating">
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo url('/show_details'); ?>/bid/<?php echo htmlentities($item['bid']); ?>"><i class="fa fa-star"></i></a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo url('/show_details'); ?>/bid/<?php echo htmlentities($item['bid']); ?>"><i class="fa fa-star"></i></a>
                                                            </li>
                                                    ...
                                                    <h4>
                                                        <a href="<?php echo url('/show_details'); ?>/bid/<?php echo htmlentities($item['bid']); ?>"><?php echo htmlentities($item['bname']); ?></a>
                                                    </h4>
