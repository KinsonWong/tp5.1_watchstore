<?php /*a:1:{s:75:"D:\phpstudy_pro\WWW\watchstore\application\admin\view\admin\order_list.html";i:1600434530;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <script>
      layui.use('table', function(){
        ...
        table.render({
          ...
          {field: 'detail', title: '订单详情',width:270,templet: '#titleTpl'},
          {field: 'consignee', title: '收件人',width:100,},
          {field: 'contact', title: '联系电话'} ,
          {field: 'all_price', title: '应付金额',width:100,sort: true},
          {field: 'discounts', title: '优惠金额',width:100,sort: true},
          {field: 'pay', title: '实付金额',width:100,sort: true},
