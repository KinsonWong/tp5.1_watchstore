<?php /*a:1:{s:73:"D:\phpstudy_pro\WWW\watchstore\application\user\view\user\user_order.html";i:1600154976;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
      ...
      <table class="layui-table">
        ...
        <?php foreach($user_orders as $values): ?>
          <tr>
            ...
            <td>-</td>
            <?php elseif(($values['status']==2)): ?>
            <td><a class="layui-btn layui-btn-normal layui-btn-xs" onclick="receive_confirm(this, '<?php echo htmlentities($values['o_id']); ?>')" href="javascript:;">确认收货</a></td>
            <?php else: ?><td>-</td>
            <?php endif; ?>
          </tr>
        <?php endforeach; ?>
