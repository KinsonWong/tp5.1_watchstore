<?php /*a:4:{s:74:"D:\phpstudy_pro\WWW\watchstore\application\product\view\product\plist.html";i:1600242892;s:40:"public/static/product/header/header.html";i:1600172054;s:40:"public/static/product/footer/footer.html";i:1600066032;s:40:"public/static/product/dialog/dialog.html";i:1599459818;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12">
                    <div class="logo-area text-center logo-xs-mrg">
                        <a href="<?php echo url('/show_index'); ?>">
                            <img src="/public/static/product/images/Watch League.png" style="width:400px;height:80px" alt="logo">
                        </a>
                    </div>
                </div>
                                ...
                                <div class="mini-cart-sub">
                                    <div class="cart-product" v-for="info in cart_info">
                                        <div class="single-cart">
                                            ...
                                            <div class="cart-info">
                                                <h5><a :href="'<?php echo url('/show_details'); ?>/bid/'+info.bid">{{info.bname}}</a></h5>
                    ...
                    <div class="menu-area">
                        <nav>
                            <ul>
                                ...
                                <li><a href="<?php echo url('/show_plist'); ?>">分类<i
                                        class="fa fa-angle-down"></i></a>
                                    <div class="mega-menu">
                                        <span v-for="item in result.dataTypes">
                                            <a :href="'<?php echo url('/show_plist'); ?>/type/'+item.type" class="title">{{item.type}}</a>
                                            <a :href="'<?php echo url('/show_details'); ?>/bid/'+info.bid" v-for="info in item.value">{{info.bname}}</a>
                                        </span>
                                    </div>
                                </li>
                                <li>
                    ...
                    <div class="mobile-menu">
                        <nav id="mobile-menu-active" style="display: block;">
                            <ul id="nav">
                                ...
                                <li><a href="<?php echo url('/show_plist'); ?>">最新<i
                                        class="fa fa-angle-down"></i></a>
                                    <div class="mega-menu">
                                        <span v-for="item in result.dataNew">
                                            <a :href="'<?php echo url('/show_plist'); ?>/type/'+item.type" class="title">{{item.type}}</a>
...
</div><!-- breadcrumbs-area-end --><!-- shop-main-area-start -->
<div class="shop-main-area mb-70">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="shop-left">
                    <div class="section-title-5 mb-30"><h2>手表</h2></div>
                    <div class="left-title mb-20"><h4>分类</h4></div>
                    <div class="left-menu mb-30">
                        <ul>
                            ...
                            <li><a href="<?php echo url('/show_plist'); ?>/type/<?php echo htmlentities($item['name']); ?>"><?php echo htmlentities($item['name']); ?><span>(<?php echo htmlentities($item['value']); ?>)</span></a>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                    <div class="left-title mb-20"><h4>热卖</h4></div>
                                        ...
                                        <div class="product-total-2">
                                            ...
                                            <div class="single-most-product bd mb-18">
                                                ...
                                                <div class="most-product-content">
                                                    ...
                                                    <h4>
                                                        <a href="<?php echo url('/show_details'); ?>/bid/<?php echo htmlentities($watchOrderItem['bid']); ?>"><?php echo htmlentities($watchOrderItem['bname']); ?></a>
                                                    </h4>
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <div class="category-image mb-30"><a href="javascript:void(0);"><img
                        src="/public/static/product/images/77.jpg" alt="banner"></a></div>
                <div class="section-title-5 mb-30"><h2>列表</h2></div>
                <div class="tab-content">
                    <div class="tab-pane active" id="th">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6"><!-- single-product-start -->
                                <div class="product-wrapper mb-40 hidden-sm">
                                    <div class="product-img">
                                        ...
                                        <img style="width: 200px;height: 200px;" src="/upload/img/<?php echo htmlentities($watchDataItem['cover']); ?>" alt="watch"
                                            class="primary"></a>
                                        <div class="quick-view">
                                            <button style="display: none" id="open" data-target="#productModal" data-toggle="modal">打开商品预览</button>
                                            <a class="action-view" href="javascript:void(0);" onclick="showProductDetail('<?php echo htmlentities($watchDataItem['bid']); ?>')" title="商品预览">
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <h4>
                                            ...
                                            <a href="<?php echo url('/show_details'); ?>/bid/<?php echo htmlentities($watchDataItem['bid']); ?>"><?php echo htmlentities($watchDataItem['bname']); ?></a>
                                        </h4>
                                        <div class="product-price">
                                            <ul>
                                    ...
                                    <div class="product-link">
                                        <div class="product-button">
                                            <a href="javascript:void(0);" onclick="add_cart_f('<?php echo htmlentities($watchDataItem['bid']); ?>')" title="加入购物车">
                                        ...
                                        <div class="add-to-link">
                                            <ul>
                                                <li>
                                                    <a href="<?php echo url('/show_details'); ?>/bid/<?php echo htmlentities($watchDataItem['bid']); ?>" title="详细">
                                ...
                                </div><!-- single-product-end --></div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                </div><!-- single-shop-end -->
            </div>
                </div><!-- tab-area-end --><!-- pagination-area-start -->
                <div class="pagination-area mt-50" style="position: relative">
                    <?php echo $watchData; ?>
                </div><!-- pagination-area-end --></div>
        </div>
    </div>
</div>
<!DOCTYPE html>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-footer br-2 xs-mb">
                                <div class="footer-title mb-20"><h3>商品</h3></div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-footer br-2 xs-mb">
                                <div class="footer-title mb-20"><h3>公司</h3></div>
                                <div class="footer-mid-menu">
                                    <ul>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-footer br-2 xs-mb">
                                <div class="footer-title mb-20"><h3>您的账户</h3></div>
                                <div class="footer-mid-menu">
                                    <ul>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="single-footer mrg-sm">
                        <div class="footer-title mb-20"><h3>其它</h3></div>
                        <div class="footer-contact">
                            <p><span>联系我们：</span>xxx-xxxxxxxx</p>
                            <p><span>Email：</span> xxxxx@mail.com</p></div>
                    </div>
                </div>
            </div>
        </div>
    </div><!-- footer-mid-end --><!-- footer-bottom-start -->
    <div class="footer-bottom">
        <div class="container">
            <div class="row bt-2">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="copy-right-area"><p>2020 Copyright @ Watch League All Right Reserved.</p></div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="payment-img text-right"><a href="javascript:void(0);"><img
                            src="/public/static/product/images/1.png" style="width:294px; height:32px" alt="payment"></a></div>
                </div>
            </div>
        </div>
    </div><!-- footer-bottom-end --></footer><!-- footer-area-end --><!-- all js here --><!-- jquery latest version -->
</body>
</html>
<style>
    .btn-add-cart{
            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div class="modal-tab">
                            <div class="product-details-large tab-content" style="margin-bottom: 20px">
                                <div class="tab-pane active" id="image-1" style="text-align: center;">
                                    <img :src="'/upload/img/'+b_detail.cover" style="width: 340px;height: 340px;border-radius: 8px" alt="">
                                </div>
                            </div>
                            <div class="product-details-small quickview-active owl-carousel owl-loaded owl-drag">
                                <div class="owl-stage-outer">
                                    <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0s;text-align: center">
                                        <a class="active" v-for="item in b_detail.imgs" href="#">
                                            <img style="width: 115px;height: 115px;margin: 2px" :src="'/upload/img/'+item.img" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="owl-dots">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="modal-pro-content"><h3>{{b_detail.bname}}</h3>
...
</div><!-- Modal end --><!-- all js here --><!-- jquery latest version -->
