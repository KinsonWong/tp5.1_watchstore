<?php /*a:1:{s:83:"D:\phpstudy_pro\WWW\watchstore\application\admin\view\admin_product\watch_edit.html";i:1600521872;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="productname" name="bname" required=""
                autocomplete="off" class="layui-input" value="<?php echo htmlentities($result['bname']); ?>" style="width: 450px;" placeholder="请输入商品名称">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="brand" name="brand" required="" value="<?php echo htmlentities($result['brand']); ?>" autocomplete="off" class="layui-input" style="position:absolute;z-index:2;width:82%;" placeholder="请输入或选择">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="type" name="type" required="" value="<?php echo htmlentities($result['type']); ?>" autocomplete="off" class="layui-input" style="position:absolute;z-index:2;width:82%;" placeholder="请输入或选择">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="price" name="price" required="" value="<?php echo htmlentities($result['price']); ?>"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="store" name="store" required="" value="<?php echo htmlentities($result['store']); ?>"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width: 30%">
            <textarea name="detail" required="" autocomplete="off" placeholder="请输入商品介绍，可不填" class="layui-textarea" ><?php echo htmlentities($result['detail']); ?></textarea>
        </div>
    </div>
