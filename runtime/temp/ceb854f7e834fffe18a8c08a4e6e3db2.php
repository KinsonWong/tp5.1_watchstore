<?php /*a:1:{s:77:"D:\phpstudy_pro\WWW\watchstore\application\admin\view\admin\address_edit.html";i:1600504051;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <form class="layui-form order-edit-top">
      <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
             <input type="hidden" name="h_a_id" value="<?php echo htmlentities($address['h_a_id']); ?>">
              ...
              autocomplete="off" value="<?php echo htmlentities($address['consignee']); ?>" class="layui-input">
          </div>
      ...
      <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
              <input type="text" value="<?php echo htmlentities($address['contact']); ?>" id="contact" name="contact" required=""
