<?php /*a:1:{s:70:"D:\phpstudy_pro\WWW\watchstore\application\admin\view\admin\login.html";i:1602307503;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-fluid">
        <div class="layui-row layui-col-space15">
            <div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
                <blockquote class="layui-elem-quote">WatchLeague管理员后台登陆</blockquote>
            </div>
        </div>
    </div>
    <!-- Head End -->
