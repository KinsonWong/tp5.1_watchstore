<?php /*a:3:{s:68:"D:\phpstudy_pro\WWW\watchstore\application\user\view\user\login.html";i:1601262157;s:40:"public/static/product/header/header.html";i:1601974929;s:40:"public/static/product/footer/footer.html";i:1601781026;}*/ ?>
<!DOCTYPE html>
<html
                ...
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
                    <form id="login-form">
                        <div class="login-form">
                            ...
                            <a href="<?php echo url('/show_forget_password'); ?>" style="float: right;margin-top:-40px;">忘记密码?</a>
                        </div>
                    </form>
                </div>
            </div>
