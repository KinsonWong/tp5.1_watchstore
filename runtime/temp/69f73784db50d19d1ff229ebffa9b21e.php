<?php /*a:3:{s:74:"D:\phpstudy_pro\WWW\watchstore\application\product\view\product\check.html";i:1600493544;s:40:"public/static/product/header/header.html";i:1600172054;s:40:"public/static/product/footer/footer.html";i:1600066032;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="left: 25%">
                <div class="checkbox-form choice-addr"><h3>选择收货地址</h3>
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <a class="pay" href="javascript:void(0);" style="line-height: 42px;padding: 0px 27px;height: 42px;" @click="add_harvest_addr">选用其它地址</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="different-address">
                    <div class="order-notes">
                        <div class="checkout-form-list"><label for="checkout-mess">买家留言</label>
                            <textarea placeholder="请输入您的留言" v-model="l_mes" rows="10"
...
</div><!-- checkout-area-end --><!-- footer-area-start -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
